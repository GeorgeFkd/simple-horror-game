...
enum class LineType { Vertex, Texcoord, Normal, Face, Mtllib, Usemtl, Group, Comment, Unknown };

inline LineType classify_line_type(std::string_view kw) {
    if (kw == "v")
        return LineType::Vertex;
    else if (kw == "vt")
        return LineType::Texcoord;
    else if (kw == "vn")
        return LineType::Normal;
    else if (kw == "f")
        return LineType::Face;
    else if (kw == "usemtl")
        return LineType::Usemtl;
    else if (kw == "g")
        return LineType::Group;
    else if (kw == "mtllib")
        return LineType::Mtllib;
    else if (kw == "#")
