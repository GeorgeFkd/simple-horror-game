...
//
//     SDL_Window* window =
//         SDL_CreateWindow("Old room", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, INITIAL_WIDTH,
...
//     auto overhead_light = Models::Model("assets/models/light_sphere.obj", "Overhead light");
//     // hi
...
//     auto      chair1 =
//         Models::Model("assets/models/SimpleOldTownAssets/ChairCafeWhite01.obj", "Chair 1");
//     chair1_offset =
//         glm::rotate(chair1_offset, glm::radians(90.0f), glm::vec3(0, 1, 0)); // rotate around Y-axis
//     chair1.set_local_transform(chair1_offset);
//     gameState.add_model(chair1);
//
...
//     gameState.add_model(table);
//
//     glm::mat4 tablechair_offset = OFFSET(bed_position, glm::vec3(-1.0f, 0.0f, -2.0f));
//     auto      tablechair = Models::Model(MODELS_FOLDER + "ChairCafeWhite01.obj", "TableChair");
//     tablechair.set_local_transform(tablechair_offset);
//     gameState.add_model(tablechair);
//
//     auto      overhead_light_model  = Models::Model("assets/models/light_sphere.obj", "lamp");
...
//     });
//     gameState.add_model(overhead_light_model);
//
...
//     // gameState.add_model(rightlight_model);
//
...
//     gameState.add_model(pot4);
//
//     auto      watering_can = Models::Model(MODELS_FOLDER + "watering-can.obj", "watering-can");
...
//     gameState.add_model(watering_can);
//
...
//     gameState.add_model(plant);
//
//     auto      dining        = Models::Model(MODELS_FOLDER + "dining-place.obj", "dining-place");
//     glm::mat4 dining_offset = OFFSET(bed_position, glm::vec3(-5.5f, 0.0f, -4.5f));
//     dining.set_local_transform(dining_offset);
//     gameState.add_model(dining);
//
//     auto wall_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall_large-place");
//     glm::mat4 wall_large_offset = OFFSET(bed_position, glm::vec3(-3.5f, 0.0f, -6.5f));
//     wall_large.set_local_transform(wall_large_offset);
//     gameState.add_model(wall_large);
//     auto wall2_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall2_large-place");
...
//     gameState.add_model(wall2_large);
//
//     auto wall3_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall3_large-place");
...
//     gameState.add_model(wall3_large);
//     auto wall4_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall4_large-place");
...
//     gameState.add_model(wall4_large);
//     auto wall5_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall5_large-place");
...
//     gameState.add_model(wall5_large);
//
//     auto wall6_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall6_large-place");
...
//     gameState.add_model(wall6_large);
//     auto wall7_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall7_large-place");
...
//     gameState.add_model(wall7_large);
//
//     auto wall8_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall8_large-place");
...
//     gameState.add_model(wall8_large);
//     auto wall9_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall9_large-place");
...
//     gameState.add_model(wall9_large);
//     auto wall10_large =
//         Models::Model(MODELS_FOLDER + "OldHouseBrownWallLarge.obj", "wall10_large-place");
...
//     gameState.add_model(wall10_large);
//
//     Material material;
//     {
...
//         gameState.add_model(ceiling);
//         gameState.add_model(wallF);
//         gameState.add_model(wallB);
//         gameState.add_model(wallL);
//         gameState.add_model(wallR);
//     }
//
//     {
//         gameState.add_light(flashlight);
//         // scene_manager.add_light(right_spotlight);
//         gameState.add_light(overhead_spot);
//     }
//
